...
export class ProjectService {
  ...
  saveComponents(projectId: string, lineId: string, components: ComponentInput[], revisedPrice: number | null, marginPct: number | null, parent?: { name?: string; description?: string | null; services?: string | null; quantity?: number; unit?: string | null }): Observable<ComponentRow[]> {
    return this.api.post<ComponentRow[]>(`/api/projects-v2/${projectId}/items/${lineId}/components`, {
      ...
      parentQuantity: parent?.quantity, parentUnit: parent?.unit,
    });
  }
  ...
  updateLineDetails(
    ...
    body: {
      name?: string; description?: string | null; services?: string | null; details?: string | null;
      cost?: number | null; unit?: string | null; categoryId?: string | null;
    },
  ): Observable<QuoteLine> {
