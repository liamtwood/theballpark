 ...
 *  Consumed ONLY by the login page's dev picker since v2.12d (Liam,
 *  2026-06-12: one account = one role — the header View-as switcher was
 *  removed; role testing happens via separate accounts/sign-ins). */
...
/** The three experiences the dev picker offers (Liam, 2026-06-11 — role
