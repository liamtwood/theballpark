...
//
// v2.12b's /auth/orgs + /auth/switch-org were REMOVED in v2.12d (Liam,
// 2026-06-12: one account = one role; role testing uses separate accounts).
// If a real customer org switcher lands later, resurrect from e7b4bd5.
