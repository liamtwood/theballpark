...
app.use(cors({ origin: ['http://localhost:5173', 'http://localhost:5174', 'http://localhost:4200', 'https://theballpark.vercel.app', 'https://theballpark.ai', 'https://www.theballpark.ai', 'https://preview.theballpark.ai'] }));
