...
@Component({
  ...
  template: `
    ...
    <ng-container *ngIf="!loading">
      ...
      <div class="bp-hero">
        <h1 class="bp-hero-title">Settings</h1>
        <p class="bp-hero-sub">{{ org?.name || 'Organisation' }} &middot; Manage your workspace</p>
      </div>
      ...
      <p-tabView>
        ...
        <p-tabPanel header="Appearance">
          <div class="mt-4" style="display:grid;grid-template-columns:1fr 360px;gap:32px;">
            ...
            <div>
              <!-- PLATFORM section -->
              <div class="bp-appearance-section">
                <h3 class="bp-appearance-section-title">Platform</h3>
                <div class="bp-field">
              ...
              <!-- TERMINOLOGY section -->
              <div class="bp-appearance-section">
                <h3 class="bp-appearance-section-title">Terminology</h3>
              ...
              <!-- MODE section -->
              <div class="bp-appearance-section">
                <h3 class="bp-appearance-section-title">Mode</h3>
                <div style="display:flex;gap:8px;margin-top:8px;">
                  <button (click)="selectMode('light')" [class.bp-mode-active]="appearance.mode === 'light'" class="bp-mode-option">
                    &#x2600;&#xFE0F; Light
                  </button>
                  <button (click)="selectMode('dark')" [class.bp-mode-active]="appearance.mode === 'dark'" class="bp-mode-option">
                    &#x263E; Dark
                  </button>
                  <button (click)="selectMode('system')" [class.bp-mode-active]="appearance.mode === 'system'" class="bp-mode-option">
                    &#x1F4BB; System
                  </button>
                </div>
              </div>
              ...
              <!-- HERO BANNER section -->
              <div class="bp-appearance-section">
                <h3 class="bp-appearance-section-title">Hero Banner</h3>
                ...
                <div style="display:flex;gap:8px;margin-top:4px;margin-bottom:12px;">
                  <button (click)="appearance.heroAlign='left'" [class.bp-mode-active]="appearance.heroAlign !== 'center'" class="bp-mode-option">
                    &#x2B05; Left
                  </button>
                  <button (click)="appearance.heroAlign='center'" [class.bp-mode-active]="appearance.heroAlign === 'center'" class="bp-mode-option">
                    &#x2194;&#xFE0F; Centre
                  </button>
                </div>
                ...
                <div class="bp-toggle-list">
                  ...
                  <div class="bp-toggle-row">
                    ...
                    <label class="bp-switch"><input type="checkbox" [(ngModel)]="appearance.showUserName"><span class="bp-switch-slider"></span></label>
                  </div>
                  <div class="bp-toggle-row">
                    <span>Location pill</span>
                    <label class="bp-switch"><input type="checkbox" [(ngModel)]="appearance.showLocation"><span class="bp-switch-slider"></span></label>
                  </div>
                  <div class="bp-toggle-row">
                    <span>Upcoming events pill</span>
                    <label class="bp-switch"><input type="checkbox" [(ngModel)]="appearance.showUpcoming"><span class="bp-switch-slider"></span></label>
                  </div>
                  <div class="bp-toggle-row">
                    <span>Stats bar</span>
                    <label class="bp-switch"><input type="checkbox" [(ngModel)]="appearance.showStats"><span class="bp-switch-slider"></span></label>
                  </div>
                </div>
              </div>

              <button (click)="saveAppearance()" class="bp-action-btn">Save Appearance</button>
            </div>
  ...
  styles: [`
    ...
    /* Avatar small */
    .bp-avatar-sm {
      width: 32px; height: 32px; border-radius: 50%; background: var(--theme-bg);
    ...
    /* Appearance section structure */
    .bp-appearance-section {
      margin-bottom: 24px; padding-bottom: 20px;
      border-bottom: 0.5px solid var(--color-border);
    }
    .bp-appearance-section:last-of-type { border-bottom: none; }
    .bp-appearance-section-title {
    ...
    .bp-toggle-row {
      ...
      padding: 8px 0; font-size: var(--text-sm); color: var(--color-text-primary);
    }
    .bp-toggle-disabled {
    ...
    .bp-action-btn:hover { background: var(--theme-accent); color: #fff; }
  `]
})
export class SettingsComponent implements OnInit {
  ...
  // Appearance — extended with hero options
  ...
  ngOnInit() {
    ...
    this.appearance = {
      ...this.appearance,
      ...current,
      heroAlign: current.heroAlign || 'left',
