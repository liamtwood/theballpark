...
@Component({
  ...
  template: `
    <div class="bp-tab-stub">
      <div class="bp-stub-icon">📋</div>
      <h3 class="bp-stub-title">Estimate</h3>
      <p class="bp-stub-body">Your cost breakdown by category with supplier outreach and quote comparison.</p>
