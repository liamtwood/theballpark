...
// LEGACY — preserved for reference. Not registered to any route. The
// active Build tab is build.component.ts (catalogue-grid + projectContext).
@Component({
  selector: 'app-build-legacy',
  standalone: true,
  imports: [
...
export class BuildLegacyComponent implements OnInit {
  loading = true;
