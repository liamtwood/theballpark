...
export class ProjectService {
  ...
  upsertCategory(projectId: string, categoryId: string, data: { requirement_brief?: string; requirement_detail?: string; ballpark_budget?: number | null; status_code?: string }) {
