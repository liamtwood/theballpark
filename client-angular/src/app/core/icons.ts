...
import {
  ...
  Award,
  Bell, Bot, Briefcase, Building2, Bug,
  Calendar, CalendarDays, Camera, Car,
  ChartBar, ChartPie,
  ChefHat, Check, CheckSquare,
  ChevronDown, ChevronLeft, ChevronRight, ChevronUp,
  Circle, CircleAlert, CircleCheck, CircleDashed, CircleDot,
  CircleHelp, CircleUser, CircleX,
  ClipboardList, ClipboardPen, Clock, Code, Coffee, Compass, ContactRound, Copy,
  CornerUpLeft,
  Cpu, CreditCard,
  Database, Download,
  Ellipsis, EllipsisVertical, ExternalLink, Eye, EyeOff,
  FileQuestionMark, FileText, Flag, FlaskConical, Flower2, Folder, FolderOpen, FolderPlus,
  Gauge, Gift, GitBranch, Globe,
  Headphones, Headset, Heart, House,
  Image, Inbox, Info,
  Key,
  LayoutDashboard, LayoutGrid, Layers, Lightbulb,
  Link, Link2, List, ListFilter, LoaderCircle, Lock, LockOpen,
  Mail, MapPin, Martini, Menu, MessageCircle, MessageSquare, MessageSquareWarning, MessagesSquare,
  Mic, Microscope, Minus, Monitor, Moon, Music,
  Package, Palette, PanelLeft, Pencil, PersonStanding, Phone, Pizza, Plane, Plus,
  Rocket,
  Save, Search, Send, Settings, Share2, Shield, ShoppingBag, ShoppingCart,
